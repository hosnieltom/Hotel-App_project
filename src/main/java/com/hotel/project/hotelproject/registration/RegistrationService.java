...
import com.hotel.project.hotelproject.email.EmailSender;
...
import com.hotel.project.hotelproject.user.UserRole;
...
public class RegistrationService {
	...
	public  String register( RegistrationRequest request ) {
		...
		if( !isValidEmail ) {
 		...
 		String link = "http://localhost:8080/api/1.0/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
